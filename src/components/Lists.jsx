  ...
  return (
    <>
      {props.lists.map(list => {
        return (
          <>
            <div className="flex rounded-lg border-[.75px] h-[60px] mb-[16px] text-off-black hover:shadow-sm">
              <div key={list.listName} className="flex-auto mx-[16px] mt-[14px]">{
                list.listName}
              </div>
              <div className="dropdown dropdown-end mx-[16px]">
                ...
                <ul tabindex="0" class="dropdown-content menu p-0 shadow bg-base-100 rounded w-[123px]">
                  ...
                  <li className='hover:bg-hover'>
                    <div className='font-semibold text-off-black active:text-error-red active:fill-error-red leading-[18px]'>
                      <div className='my-[16px] ml-[16px]'>
