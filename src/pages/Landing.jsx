      ...
      <div className="desktop-sm:mx-[40px] desktop-lg:mx-[40px] mobile:mx-[24px] ">
        <div className="mt-[32px]">
          <div className="flex items-center">
            ...
            <div className="flex-none active:text-cursor-teal">
              <Link to="/create-list" className="mobile:mr-[16px] desktop-sm:mr-[40px] desktop-lg:mr-[40px]">
                  <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg" className="ml-auto hover:bg-hover">
