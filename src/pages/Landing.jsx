        ...
        <div className="mt-[32px]">
          <div className="flex items-stretch">
            ...
            <div className="flex-auto">
              <Link to="/create-list">
                  <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg" className="ml-auto mobile:mr-[16px] desktop-sm:mr-[40px] desktop-lg:mr-[40px] active:fill-cursor-teal">
